...
description: Reviews pull request changes for security risks and returns compact JSONL findings.
...
Use the `security-review` skill instructions when reviewing.
