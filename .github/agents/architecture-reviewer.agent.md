...
description: Reviews pull request changes for architecture risks and returns compact JSONL findings.
...
Use the `architecture-review` skill instructions when reviewing.
