...
description: Reviews pull request changes for regression-risk risks and returns compact JSONL findings.
...
Use the `regression-risk-review` skill instructions when reviewing.
