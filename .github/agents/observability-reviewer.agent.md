...
description: Reviews pull request changes for observability risks and returns compact JSONL findings.
...
Use the `observability-review` skill instructions when reviewing.
