...
description: Reviews pull request changes for resilience risks and returns compact JSONL findings.
...
Use the `resilience-review` skill instructions when reviewing.
