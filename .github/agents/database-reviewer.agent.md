...
description: Reviews pull request changes for database risks and returns compact JSONL findings.
...
Use the `database-review` skill instructions when reviewing.
