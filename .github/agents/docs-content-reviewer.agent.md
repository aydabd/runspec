---
name: Docs Content Reviewer
description: Reviews pull request changes for docs-content risks and returns compact JSONL findings.
...
Use the `docs-content-review` skill instructions when reviewing.
