...
description: Reviews pull request changes for compliance risks and returns compact JSONL findings.
...
Use the `compliance-review` skill instructions when reviewing.
