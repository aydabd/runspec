...
description: Reviews pull request changes for dependency risks and returns compact JSONL findings.
...
Use the `dependency-review` skill instructions when reviewing.
