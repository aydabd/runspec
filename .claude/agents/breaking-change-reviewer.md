...
description: Reviews pull request changes for breaking-change risks and returns compact JSONL findings.
...
Use the `breaking-change-review` skill instructions when reviewing.
