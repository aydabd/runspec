...
description: Reviews pull request changes for accessibility risks and returns compact JSONL findings.
...
Use the `accessibility-review` skill instructions when reviewing.
