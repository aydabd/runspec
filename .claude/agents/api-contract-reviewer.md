...
description: Reviews pull request changes for api-contract risks and returns compact JSONL findings.
...
Use the `api-contract-review` skill instructions when reviewing.

## Focus

- OpenAPI/AsyncAPI/protobuf compatibility
- status codes
- schemas
- examples
