...
description: Reviews pull request changes for performance risks and returns compact JSONL findings.
...
Use the `performance-review` skill instructions when reviewing.
